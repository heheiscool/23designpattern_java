 ...
 * @Author: chenyang
 * @Description: snake互动区域
 * @Date: 2021/7/18 11:57 下午
 * @Version: 1.0
 */
import javax.swing.*;
import java.awt.*;
...
public class SnakePanel extends JPanel implements Runnable,KeyListener{
    ...
    private void updateColors(){
        ...
        gridsPanel[snakeHead.getX()][snakeHead.getY()].setBackground
                (headColor);
        //设定背景颜色
        ...
        gridsPanel[snakeFood.getX()][snakeFood.getY()].setBackground
                (foodColor);
    }
